...
public:
    ...
    void printConversation(struct Conversation conversation[], int arrLength);

    void queryConversation(std::string username);

    void queryMessage(std::string conversationID);

    // check username and password
    bool authenticateLogin(std::string clientUsername, std::string clientPassword);

    // insert conversation
    bool insertConversation(std::string conversationID);
    ...
    bool insertConversationHandler(std::string conversationID, std::string username);
