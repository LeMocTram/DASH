...
CREATE TABLE `ADMINISTRATE` (
  ...
  CONSTRAINT `ADMINISTRATE_ibfk_1` FOREIGN KEY (`username`) REFERENCES `USER` (`username`),
  CONSTRAINT `ADMINISTRATE_ibfk_2` FOREIGN KEY (`conversationID`) REFERENCES `CONVERSATION` (`conversationID`)
...
LOCK TABLES `ADMINISTRATE` WRITE;
...
-- Dump completed on 2023-08-30 10:08:06
